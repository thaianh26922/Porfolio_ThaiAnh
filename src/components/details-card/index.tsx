          ...
          {loading || !profile ? (
            ...
            <Fragment>
              ...
              <ListItem
                ...
                title="GitHub:"
                value='thaianh26922'
                link={`https://github.com/thaianh26922`}
              />
              {social?.researchGate && (
                <ListItem
                  icon={<SiResearchgate />}
              ...
              {social?.facebook && (
                <ListItem
                  ...
                  link={`https://www.facebook.com/thaianh26922`}
                />
              )}
              {social?.instagram && (
                <ListItem
                  ...
                  link={`https://www.instagram.com/thaianh26922`}
                />
              )}
              {social?.reddit && (
                <ListItem
              ...
              {social?.email && (
                <ListItem
                  icon={<RiMailFill />}
                  title="Email:"
                  value='thaianh26902@gmail.com'
                  link={`mailto:thaianh26902@gmail.com`}
                />
              )}
            </Fragment>
          )}
